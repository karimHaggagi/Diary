...
import com.example.diaryapp.presentation.screens.home.component.Gallery
import com.example.diaryapp.presentation.screens.home.component.PlusOverlay
import com.example.diaryapp.presentation.screens.write.component.MoodPager
import com.example.diaryapp.presentation.screens.write.component.WriteTopBar
            ...
            Column(
                ...
                Row(modifier = Modifier.fillMaxWidth()) {
                    ...
                    if (state.images.isNotEmpty()) {
                        Gallery(images = state.images, onImageClicked = {onEventChanged(WriteContract.WriteEvent.OnImageSelected(it))})
                    }
                }
